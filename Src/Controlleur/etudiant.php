<?php
    ...
    class Etudiant
    {
        ...
        private function __construct($id, $login, $mdp, $mail, $niveau, $nDossier,  $prenom, $nom, $dateNaissance, $universite, $villeEtablissement, $cycle, $anneeEtude, $bac, $anneeBac, $mentionBac, $etablissementBac, $numeroPortable, $matiereSuivies)
        {
